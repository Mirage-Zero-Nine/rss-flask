...
def convert_time_currency(created_time_string):
    # 2022.03.18 14:35:42
    # todo: combine two functions
    converted_time = datetime.strptime(created_time_string, '%Y.%m.%d %H:%M:%S')
...
if __name__ == '__main__':
    ...
    print(convert_time_currency("2022.03.18 14:35:42"))
