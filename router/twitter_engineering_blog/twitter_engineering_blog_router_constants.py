...
twitter_engineering_blog_key = '/twitter/blog'
twitter_engineering_blog_period = 30 * 60 * 1000  # 30 minutes
twitter_engineering_blog_date_format = "%A, %d %B %Y"
twitter_engineering_blog_author = "Twitter Engineering Blog"  # they don't have a specific author
